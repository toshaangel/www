 ...
 *
 * @command QuestSet
* @text Квест: Добавить/Завершить/Провалить/Удалить
* @desc Добавляет квест(ы), чтобы они были известны/завершены/провалены.
* Или удаляет их.

* @arg Keys:arraystr
* @text Ключи квестов
* @type string[]
* @desc Вставьте ключ(и) квеста здесь.
* Каждый ключ квеста должен быть уникален.
* @default []

* @arg Status:str
* @text Статус
* @type select
* @option Добавить в известные
* @value known
* @option Добавить в завершенные
* @value completed
* @option Добавить в проваленные
* @value failed
* @option Удалить из всех
* @value remove
* @desc Изменить статус на этот.
* @default known

* --------------------------------------------------------------------------
*
* @command QuestDescription
* @text Квест: Изменение Описания
* @desc Изменяет описание квеста(ов) на ID.
...
* @arg TargetID:eval
* @text ID Описания
* @desc Измените описание квеста(ов) на другой ID.
* Вы можете использовать JavaScript код.
* @default 1

* --------------------------------------------------------------------------
*
* @command QuestObjectives
* @text Квест: Изменение Целей
* @desc Изменяет статус цели(ей) квеста(ов).
...
* @text ID Цели(ей)
* @type string[]
* @desc Выберите ID цели(ей), который(е) нужно изменить.
* Вы можете использовать JavaScript код.
* @default ["1"]
...
* @text Статус
* @type select
* @option Показать Цель(и)
* @value show
* @option Завершить Цель(и)
* @value complete
* @option Провалить Цель(и)
* @value fail
* @option Удалить Цель(и)
* @value remove
* @desc Изменить статус цели(ей) на этот.
* @default show

* --------------------------------------------------------------------------
*
* @command QuestQuote
* @text Квест: Изменение Цитаты
* @desc Изменяет цитату квеста(ов) на ID.
...
* @arg TargetID:eval
* @text ID Цитаты
* @desc Измените цитату квеста(ов) на другой ID.
* Вы можете использовать JavaScript код.
* @default 1
 *
 * @ --------------------------------------------------------------------------
...
* @text Квест: Изменение Наград
* @desc Изменяет статус наград(ы) квеста(ов).
...
* @text ID Наград(ы)
* @type string[]
* @desc Выберите ID наград(ы) для изменения.
* Вы можете использовать JavaScript код.
* @default ["1"]
...
* @text Статус
* @type select
* @option Показать Награду(ы)
* @value show
* @option Получить Награду(ы)
* @value claim
* @option Отклонить Награду(ы)
* @value deny
* @option Удалить Награду(ы)
* @value remove
* @desc Изменить статус наград(ы) на этот.
* @default show

* --------------------------------------------------------------------------
*
* @command QuestSubtext
* @text Квест: Изменение Подтекста
* @desc Изменяет подтекст квеста(ов) на ID.
...
* @arg TargetID:eval
* @text ID Подтекста
* @desc Измените подтекст квеста(ов) на другой ID.
* Вы можете использовать JavaScript код.
* @default 1
...
* @text Метка: Добавить Метку Квеста
* @desc Добавляет метки квестов к указанным предметам, оружию и броне.

* @arg ItemIDs:arraynum
* @text ID Предмета(ов)
* @type item[]
* @desc Выберите, к каким ID предмета(ов) добавить метки квестов.
* @default []

* @arg WeaponIDs:arraynum
* @text ID Оружия
* @type weapon[]
* @desc Выберите, к каким ID оружия добавить метки квестов.
* @default []

* @arg ArmorIDs:arraynum
* @text ID Брони
* @type armor[]
* @desc Выберите, к каким ID брони добавить метки квестов.
* @default []

* --------------------------------------------------------------------------
*
* @command LabelClearQuestLabel
* @text Метка: Очистить Метку Квеста
* @desc Очищает метки квестов с указанных предметов, оружия и брони.

* @arg ItemIDs:arraynum
* @text ID Предмета(ов)
* @type item[]
* @desc Выберите, с каких ID предмета(ов) очистить метки квестов.
* @default []

* @arg WeaponIDs:arraynum
* @text ID Оружия
* @type weapon[]
* @desc Выберите, с каких ID оружия очистить метки квестов.
* @default []

* @arg ArmorIDs:arraynum
* @text ID Брони
* @type armor[]
* @desc Выберите, с каких ID брони очистить метки квестов.
* @default []
 *
 * @ --------------------------------------------------------------------------
 *
...
* @text Трекер: Изменить Квест
* @desc Изменяет отслеживаемый квест.

* @arg Key:str
* @text Ключ Квеста
* @desc Вставьте ключ квеста здесь.
* @default Example

* --------------------------------------------------------------------------
*
* @command TrackerRefreshWindow
* @text Трекер: Обновить Окно
* @desc Обновляет окно трекера квестов.

* --------------------------------------------------------------------------
*
* @command TrackerShowHide
* @text Трекер: Показать/Скрыть Окно
* @desc Может принудительно скрыть окно.
* Показ будет зависеть от настройки опций игрока.
...
* @on Показать
* @off Скрыть
* @desc Показывает/скрывает окно трекера на карте.
* @default true
...
* @text Система: Вызвать Scene_Quest
* @desc Открывает Scene_Quest для игрока.
* Не работает в бою.

* --------------------------------------------------------------------------
*
* @command SystemEnableQuestMenu
* @text Система: Включить Квесты в Меню?
* @desc Включает/отключает меню квестов в основном меню.
...
* @text Система: Показать Квесты в Меню?
* @desc Показывает/скрывает меню квестов в основном меню.
...
*
* @param QuestSystem
* @default Параметры Плагина
*
* @param ATTENTION
* @default ПРОЧИТАЙТЕ ФАЙЛ СПРАВКИ
*
* @param BreakSettings
* @text --------------------------
* @default ----------------------------------
 ...
 * @type struct<General>
 * @desc Общие настройки для системы квестов.
 ...
 * @text Категории квестов
 * @type struct<Category>[]
 * @desc Список категорий и их квестов.
 ...
 *
 * @param Label:struct
 * @text Настройки метки квеста
 * @type struct<Label>
 * @desc Измените, как метки квестов применяются к вашему игровому проекту.
 * @default {"Icon:num":"0","Text:str":"КВЕСТ","FontColor:str":"24","FontFace:str":"Verdana","FontSize:str":"16","FadeLimit:num":"360","FadeSpeed:num":"4","OffsetX:num":"0","OffsetY:num":"-12"}

 * @param Tracker:struct
 * @text Настройки трекера квестов
 * @type struct<Tracker>
 * @desc Настройте работу трекера квестов.
 * @default {"General":"","TrackerFmt:json":"\"\\\\{[[Title]]\\\\}\\n[[Objectives]]\"","Options":"","AdjustRect:eval":"true","AddShowOption:eval":"true","ShowName:str":"Показать трекер квестов","AddPositionOption:eval":"true","PositionName:str":"Позиция трекера квестов","PositionOff:str":"←","PositionOn:str":"→"}

 * @param MainMenu:struct
 * @text Настройки главного меню
 * @type struct<MainMenu>
 * @desc Настройте значения по умолчанию для главного меню.
 * @default {"Name:str":"Квесты","ShowMainMenu:eval":"true","EnableMainMenu:eval":"true"}

 * @param BgSettings:struct
 * @text Настройки фона
 * @type struct<BgSettings>
 * @desc Настройки фона для Scene_Quest.
 * @default {"SnapshotOpacity:num":"192","BgFilename1:str":"","BgFilename2:str":""}

 * @param Window:struct
 * @text Настройки окна
 * @type struct<Window>
 * @desc Настройте внешний вид всех окон в игре.
 ...
 * @text Известные квесты
 * @parent StartingQuests
 * @type string[]
 * @desc Какие квесты известны в начале игры?
 * Вставьте их ключи здесь.
 ...
 * @parent StartingQuests
 * @type string[]
 * @desc Какие квесты завершены в начале игры?
 * Вставьте их ключи здесь.
 * @default []
 *
 * @param FailedQuests:arraystr
 * @text Проваленные квесты
 * @parent StartingQuests
 * @type string[]
 * @desc Какие квесты провалены в начале игры?
 * Вставьте их ключи здесь.
 * @default []
 *
 * @param TrackedQuest:str
 * @text Отслеживаемый квест
 * @parent StartingQuests
 * @desc Какой квест отслеживается в начале игры?
 * @default Welcome
 *
 * @param SceneQuest
 * @text Scene_Quest
 ...
 * @text Команда: Известно
 * @parent VocabCommandWindow
 * @desc Текст, используемый для отображения известных квестов.
 * @default Доступно
 *
 * @param CommandWindow_Completed_Text:str
 * @text Команда: Завершено
 * @parent VocabCommandWindow
 * @desc Текст, используемый для отображения завершенных квестов.
 * @default Завершено
 *
 * @param CommandWindow_Failed_Text:str
 * @text Команда: Провалено
 * @parent VocabCommandWindow
 * @desc Текст, используемый для отображения проваленных квестов.
 * @default Провалено
 *
 ...
 * @desc Текст, отображаемый в окне меток, когда ни один квест не выбран.
 * @default \i[186]Журнал квестов
 *
 ...
 * @text Открытые категории
 * @parent VocabListWindow
 * @desc Формат текста для открытой категории.
 * %1 - Название категории, %2 - Количество квестов
 * @default - %1(%2)
 *
 * @param ListWindowCategoryCloseFmt:str
 * @text Закрытые категории
 * @parent VocabListWindow
 * @desc Формат текста для закрытой категории.
 * %1 - Название категории, %2 - Количество квестов
 * @default + %1(%2)
 *
 * @param NoQuestListed:str
 * @text Нет перечисленных квестов
 * @parent VocabListWindow
 * @desc Текст, когда квест не перечислен.
 * @default (Квесты не перечислены)
 *
 * @param ListWindowTrackedQuest:str
 * @text Отслеживаемый квест
 * @parent VocabListWindow
 * @desc Формат текста для отслеживаемого квеста.
 * %1 - Название отслеживаемого квеста
 * @default \c[17]%1\c[0]
 *
 ...
 * @type note
 * @desc Текст, отображаемый, когда квест не выбран.
 * @default "\\c[5]Основные квесты\\c[0] - это квесты, которые необходимо\nвыполнить для дальнейшего продвижения\nв сюжете игры.\n\n\\c[6]Побочные квесты\\c[0] - это необязательные квесты, которые можно\nвыполнить по вашему усмотрению. После\nвыполнения побочного квеста вы можете получить\nполезные награды, которые могут помочь вам в\nвашем путешествии."
 *
 * @param OnLoadQuestJS:func
 * @text JS: При Загрузке
 * @parent LogEmpty:json
 * @type note
 * @desc Выполняет код при создании пустого сообщения.
 * Полезно для настройки переменных.
 * @default "// Вставьте сюда JavaScript код."
 *
 * @param LogFmt:json
 * @text Формат журнала квестов
 * @parent VocabLogWindow
 * @type note
 * @desc Формат текста для окна журнала квестов.
 * Читайте файл помощи для инструкций.
 * @default "\\{[[Title]]\\}\n\\c[4]Уровень:\\c[0] [[Difficulty]]\n\\c[4]От кого:\\c[0] [[From]]\n\\c[4]Местоположение:\\c[0] [[Location]]\n\n\\c[4]Описание:\\c[0]\n[[Description]]\n\n\\c[4]Цели:\\c[0]\n[[Objectives]]\n\n\\c[4]Награды:\\c[0]\n[[Rewards]]\n\n[[Subtext]]\n\n[[Quote]]"
 *
 * @param Objective_Normal_Fmt:str
 * @text Формат цели (Известно)
 * @parent LogFmt:json
 * @desc Формат текста для известных целей.
 * %1 - Текст цели
 * @default ◎%1
 *
 * @param Objective_Completed_Fmt:str
 * @text Формат цели (Выполнено)
 * @parent LogFmt:json
 * @desc Формат текста для выполненных целей.
 * %1 - Текст цели
 * @default \c[24]<ColorLock>✔%1</ColorLock>\c[0]
 *
 * @param Objective_Failed_Fmt:str
 * @text Формат цели (Провалено)
 * @parent LogFmt:json
 * @desc Формат текста для проваленных целей.
 * %1 - Текст цели
 * @default \c[25]<ColorLock>✘%1</ColorLock>\c[0]
 *
 * @param Reward_Normal_Fmt:str
 * @text Формат награды (Известно)
 * @parent LogFmt:json
 * @desc Формат текста для обычных наград.
 * %1 - Текст награды
 * @default ◎%1
 *
 * @param Reward_Completed_Fmt:str
 * @text Формат награды (Получено)
 * @parent LogFmt:json
 * @desc Формат текста для полученных наград.
 * %1 - Текст награды
 * @default \c[24]<ColorLock>✔%1</ColorLock>\c[0]
 *
 * @param Reward_Failed_Fmt:str
 * @text Формат награды (Отклонено)
 * @parent LogFmt:json
 * @desc Формат текста для отклоненных наград.
 * %1 - Текст награды
 * @default \c[25]<ColorLock>✘%1</ColorLock>\c[0]
 *
 * @param ButtonAssistWindow
 * @text Окно помощи с кнопками
 * @parent Vocab
 *
 * @param ButtonAssistPageUpDown:str
 * @text Прокрутка Вверх/Вниз
 * @parent ButtonAssistWindow
 * @desc Текст для страницы Вверх/Вниз, чтобы прокручивать окно журнала.
 * Требует VisuMZ_0_CoreEngine!
 * @default Прокрутка Вверх/Вниз
 *
 * @param questButtonAssistActive:str
 * @text Трекер
 * @parent ButtonAssistWindow
 * @desc Текст для отслеживания квестов.
 * Требует VisuMZ_0_CoreEngine!
 * @default Отслеживать
 *
 ...
 * @text Развернуть
 * @parent ButtonAssistWindow
 * @desc Текст для развертывания категорий.
 * Требует VisuMZ_0_CoreEngine!
 * @default Развернуть
 *
 ...
 * @text Свернуть
 * @parent ButtonAssistWindow
 * @desc Текст для сворачивания категорий.
 * Требует VisuMZ_0_CoreEngine!
 * @default Свернуть
 *
 ...
 * @text Иконка: Известен
 * @parent CommandWindowIcons
 * @desc Иконка, используемая для этой команды.
 * @default 193
 *
 ...
 * @desc Название этой категории.
 * Вы можете использовать коды текста.
 * @default Без названия
 *
 * @param Quests:arraystruct
 * @text Квесты
 * @type struct<Quest>[]
 * @desc Список квестов, включенных в эту категорию.
 * @default []
 *
 */
/* ----------------------------------------------------------------------------
 * Настройки индивидуальных квестов
 * ----------------------------------------------------------------------------
 */
/*~struct~Quest:
 *
 * @param Key:str
 * @text Ключ квеста
 * @desc Идентификационный ключ этого квеста. Квесты требуют
 * уникальных ключей, чтобы плагин мог их различать.
 * @default (Требуется ключ)
 *
 * @param Header
 *
 * @param Title:str
 * @text Название
 * @parent Header
 * @desc Название квеста. Оно отображается в игре.
 * Вы можете использовать коды текста.
 * @default \i[87]Безымянный квест
 *
 * @param Difficulty:str
 * @text Сложность
 * @parent Header
 * @desc Уровень сложности этого квеста.
 * Вы можете использовать коды текста.
 * @default Легко
 *
 * @param From:str
 * @text От кого
 * @parent Header
 * @desc Введите имя того, кто выдал этот квест.
 * Вы можете использовать коды текста.
 * @default Имя NPC
 *
 * @param Location:str
 * @text Местоположение
 * @parent Header
 * @desc Введите название места, где был выдан этот квест.
 * Вы можете использовать коды текста.
 * @default Название места
 *
 * @param Description:arrayjson
 * @text Описание
 * @parent Header
 * @type note[]
 * @desc Введите описание(я), используемые для этого квеста.
 * Вы можете использовать коды текста.
 * @default ["\"Это \\\\c[4]стандартное\\\\c[0] описание квеста.\"","\"Это \\\\c[4]стандартное\\\\c[0] описание квеста.\\n\\nВы можете вставить несколько записей с описаниями, если захотите\\nобновить описание квеста в процессе его выполнения.\""]
 *
 * @param Lists
 *
 ...
 * @parent Lists
 * @type note[]
 * @desc Цели, которые необходимо выполнить для этого квеста.
 * Вы можете использовать коды текста.
 * @default ["\"\\\\c[4]Первая\\\\c[0] цель, которую необходимо выполнить.\"","\"\\\\c[4]Вторая\\\\c[0] цель, но она скрыта.\"","\"Чтобы отобразить другие цели,\\nактивируйте их через параметр плагина \\\\c[4]'Visible\\nObjectives'\\\\c[0] или используя плагин-команду, чтобы\\nсделать их видимыми\""]
 *
 ...
 * @type number[]
 * @min 1
 * @desc Цели, которые видимы с самого начала.
 * @default ["1"]
 *
 ...
 * @parent Lists
 * @type note[]
 * @desc Список наград за этот квест.
 * Вы можете использовать коды текста.
 * @default ["\"\\\\i[176]Зелье x5\"","\"\\\\i[178]Эфир x3\"","\"Чтобы отобразить другие награды,\\nактивируйте их через параметр плагина \\\\c[4]'Visible\\nRewards'\\\\c[0] или используя плагин-команду, чтобы\\nсделать их видимыми\""]
 *
 * @param VisibleRewards:arraynum
 * @text Видимые Награды
 * @parent Rewards:arrayjson
 * @type number[]
 * @min 1
 * @desc Награды, которые видимы с самого начала.
 * @default ["1"]
 *
 * @param Footer
 *
 ...
 * @parent Footer
 * @type note[]
 * @desc Подтекст, отображаемый вместе с квестом.
 * Вы можете использовать коды текста.
 * @default ["\"\"","\"Это \\\\c[4]подтекст\\\\c[0]. Он используется как дополнительный\\nтекст, который вы можете разместить в вашем\\nжурнале квестов, отличный от\\n\\\\c[4]описания\\\\c[0].\""]
 *
 * @param Quotes:arrayjson
 * @text Цитаты
 * @parent Footer
 * @type note[]
 * @desc Цитаты, отображаемые вместе с квестом.
 * Вы можете использовать коды текста.
 * @default ["\"\"","\"Вставьте сюда цитаты NPC.\""]
 *
 * @param JavaScript
 *
 * @param OnLoadQuestJS:func
 ...
 * @parent JavaScript
 * @type note
 * @desc Выполняет код при загрузке квеста в Scene_Quest.
 * Полезно для настройки переменных.
 * @default "// Вставьте сюда JavaScript код."
 *
 */
 ...
 * @param Icon:num
 * @text Иконка
 * @desc Индекс иконки, используемой для отображения текста "NEW!".
 * Используйте 0, чтобы не отображать иконки.
 * @default 0
 *
 * @param Text:str
 * @text Текст
 * @desc Текст, написанный на метке квеста.
 * @default QUEST
 *
 * @param FontColor:str
 * @text Цвет шрифта
 * @parent Text:str
 * @desc Используйте #rrggbb для пользовательских цветов или обычные числа
 * для цветов текста из Window Skin.
 * @default 24
 *
 * @param FontFace:str
 * @text Шрифт
 * @parent Text:str
 * @desc Шрифт, используемый для метки квеста.
 * @default Verdana
 *
 * @param FontSize:str
 * @text Размер шрифта
 * @parent Text:str
 * @desc Размер шрифта, используемый для текста квеста.
 * @default 16
 *
 * @param FadeLimit:num
 * @text Предел затухания
 * @desc Каков верхний предел непрозрачности перед обратным изменением?
 * @default 360
 *
 * @param FadeSpeed:num
 * @text Скорость затухания
 * @desc Какова скорость затухания метки квеста?
 * @default 4
 *
 * @param OffsetX:num
 * @text Смещение по X
 * @desc На сколько сместить позицию по X метки квеста.
 * @default 0
 *
 * @param OffsetY:num
 * @text Смещение по Y
 * @desc На сколько сместить позицию по Y метки квеста.
 * @default -12
 *
 */
/* ----------------------------------------------------------------------------
 * Настройки Трекера Заданий
 * ----------------------------------------------------------------------------
 */
/*~struct~Tracker:
 *
 ...
 * @parent General
 * @type note
 * @desc Формат текста для окна трекера заданий.
 * Читайте файл помощи для инструкций.
 * @default "\\{[[Title]]\\}\n[[Objectives]]"
 *
 * @param Fading
 ...
 * @type number
 * @min 0
 * @desc Минимальная прозрачность, когда игрок слишком близко к трекеру заданий на карте.
 * @default 128
 *
 * @param TrackerFadeSpeed:num
 * @text Скорость Затухания Трекера
 * @parent Fading
 * @type number
 * @min 1
 * @desc Скорость затухания трекера при включении/выключении.
 * Меньше - медленнее, больше - быстрее.
 * @default 16
 *
 * @param Options
 *
 * @param AdjustRect:eval
 * @text Настроить Высоту Окна
 * @parent Options
 * @type boolean
 * @on Настроить
 * @off Не настраивать
 * @desc Автоматически настраивать высоту окна настроек?
 * @default true
 *
 * @param AddShowOption:eval
 * @text Добавить Показать Трекер?
 * @parent Options
 * @type boolean
 * @on Добавить
 * @off Не добавлять
 * @desc Добавить опцию 'Показать Трекер' в меню настроек?
 * @default true
 *
 * @param ShowName:str
 * @text Имя Опции
 * @parent AddShowOption:eval
 * @desc Имя команды для опции.
 * @default Показать Трекер Заданий
 *
 * @param AddPositionOption:eval
 * @text Добавить Позицию Трекера?
 * @parent Options
 * @type boolean
 * @on Добавить
 * @off Не добавлять
 * @desc Добавить опцию 'Позиция Трекера' в меню настроек?
 * @default true
 *
 ...
 * @desc Имя команды для опции.
 * @default Позиция Трекера Заданий
 *
 * @param PositionOff:str
 * @text Опция ВЫКЛ
 * @parent AddPositionOption:eval
 * @desc Текст, отображаемый когда опция выключена.
 * @default ←
 *
 * @param PositionOn:str
 * @text Опция ВКЛ
 * @parent AddPositionOption:eval
 * @desc Текст, отображаемый когда опция включена.
 * @default →
 *
 */
/* ----------------------------------------------------------------------------
 ...
 * @text Имя Команды
 * @parent Options
 * @desc Имя опции 'Задания' в главном меню.
 * @default Задания
 *
 * @param ShowMainMenu:eval
 * @text Показать в Главном Меню?
 * @type boolean
 * @on Показать
 * @off Скрыть
 * @desc Добавить опцию 'Задания' в главное меню по умолчанию?
 * @default true
 *
 * @param EnableMainMenu:eval
 * @text Включить в Главном Меню?
 * @type boolean
 * @on Включить
 * @off Отключить
 * @desc Включить опцию 'Задания' в главное меню по умолчанию?
 * @default true
 *
 */
/* ----------------------------------------------------------------------------
 ...
 * @text Прозрачность Снимка
 * @type number
 * @min 0
 * @max 255
 * @desc Прозрачность снимка для сцены.
 * @default 192
 *
 ...
 * @type file
 * @dir img/titles1/
 * @desc Имя файла для нижнего фонового изображения.
 * Оставьте пустым, если не хотите использовать.
 * @default 
 *
 ...
 * @type file
 * @dir img/titles2/
 * @desc Имя файла для верхнего фонового изображения.
 * Оставьте пустым, если не хотите использовать.
 * @default 
 *
 */
 ...
 * @text Показывать Неудачные Задания?
 * @parent CommandWindow
 * @type boolean
 * @on Показать
 * @off Скрыть
 * @desc Показать/скрыть неудачные задания в окне команд.
 * @default true
 *
 * @param CmdStyle:str
 * @text Стиль
 ...
 * @option Только Текст
 * @value text
 * @option Только Иконка
 * @value icon
 * @option Иконка + Текст
 * @value iconText
 * @option Автоматически
 * @value auto
 * @desc Как вы хотите отображать команды в Окне Команд?
 * @default auto
 *
 ...
 * @option center
 * @option right
 * @desc Выравнивание текста для Окна Команд.
 * @default center
 *
 ...
 * @option 2 - Прозрачный
 * @value 2
 * @desc Выберите тип фона для этого окна.
 * @default 0
 *
 ...
 * @parent CommandWindow
 * @type note
 * @desc Код, используемый для определения размеров этого окна.
 * @default "const ww = this.mainCommandWidth();\nconst wh = this.calcWindowHeight(Window_QuestCommand.prototype.totalCommands(), true);\nconst wx = this.isRightInputMode() ? Graphics.boxWidth - ww : 0;\nconst wy = this.mainAreaTop();\nreturn new Rectangle(wx, wy, ww, wh);"
 *
 * @param QuestLabel
 * @text Надпись Задания
 *
 ...
 * @text Скорость Прокрутки Страниц
 * @parent LogWindow
 * @desc Скорость прокрутки для PageUp/Down.
 * @default 0.20
 *
 ...
 * @text Автоматический Перенос Слов?
 * @parent LogWindowExperimental
 * @type boolean
 * @on Включить
 * @off Отключить
 * @desc Включает/отключает автоматический перенос слов.
 * Требуется VisuMZ_1_MessageCore!
 * @default false
 *
 * @param ListWindow
 * @text Окно Списка
 ...
 * @desc Насколько вы хотите изменить масштаб размера окна трекера?
 * @default 0.50
 *
