...
CGMZ.SaveFile.ShowAutosaveInSaveMode = (CGMZ.SaveFile.parameters["Show Autosave in Save Mode"] === "true") ? true : false;
CGMZ.SaveFile.ShowImage = (CGMZ.SaveFile.parameters["Show Image"] === "true") ? true : false;
CGMZ.SaveFile.ShowFaces = (CGMZ.SaveFile.parameters["Show Faces"] === "true") ? true : false;
CGMZ.SaveFile.MaxSaveFiles = Number(CGMZ.SaveFile.parameters["Max Save Files"]) || 20;
CGMZ.SaveFile.SaveIconUsed = Number(CGMZ.SaveFile.parameters["File Icon Used"]) || 230;
CGMZ.SaveFile.SaveIconUnused = Number(CGMZ.SaveFile.parameters["File Icon Unused"]) || 229;
CGMZ.SaveFile.ImageHeight = Number(CGMZ.SaveFile.parameters["Image height"]) || 160;
CGMZ.SaveFile.FadeSpriteOpacity = Number(CGMZ.SaveFile.parameters["Location Fade Opacity"]) || 120;
CGMZ.SaveFile.HeaderColor = Number(CGMZ.SaveFile.parameters["Header Color"]) || 1;
CGMZ.SaveFile.DefaultImage = CGMZ.SaveFile.parameters["Default Image"];
CGMZ.SaveFile.EmptyText = CGMZ.SaveFile.parameters["Empty Text"] || "No save data exists.";
CGMZ.SaveFile.LocationText = CGMZ.SaveFile.parameters["Location Text"] || "Location: ";
CGMZ.SaveFile.PlaytimeText = CGMZ.SaveFile.parameters["Playtime Text"] || "Playtime: ";
CGMZ.SaveFile.GoldText = CGMZ.SaveFile.parameters["Gold Text"] || "Gold: ";
CGMZ.SaveFile.LevelText = CGMZ.SaveFile.parameters["Level Text"] || "Lv. ";
//=============================================================================
// Game_Map
//-----------------------------------------------------------------------------
