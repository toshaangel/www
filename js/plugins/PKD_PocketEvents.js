...
/*:
 * @plugindesc (v.1.2)[PRO] Allow you spawn Events during game with placement select
...
PKD_EPManager.Start = function(pItemIndex, gItemId = 0) {
  ...
  $gameTemp.pPauseMap = item.isShouldPauseMap === true;
...
//Plugin PKD_PocketEvents automatic build by PKD PluginBuilder 1.9.1 11.02.2021
